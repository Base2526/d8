...
class AjaxAddMore extends DemoBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach($test as $i => $v){
      $form['names_fieldset'][$i] = [
        '#type' => 'fieldset',
        '#title' => $this->t('People coming to picnic xxxx'),
        '#prefix' => '<div id="names-fieldset-wrapper'. $i . $key .'">',
        '#suffix' => '</div>',
      ];
      foreach($v as $key => $value){
        ...
        $form['names_fieldset'][$i][$key]['actions'] = [
          ...
          '#ajax' => [
            ...
            'wrapper' => 'names-fieldset-wrapper'. $i . $key,
          ],
        ];
      }
  ...
  public function removeCallback(array &$form, FormStateInterface $form_state) {
    ...
    $test = $form_state->get('test')[$last_nid[0]];
