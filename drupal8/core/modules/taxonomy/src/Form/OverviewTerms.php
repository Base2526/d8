...
class OverviewTerms extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, VocabularyInterface $taxonomy_vocabulary = NULL) {
    ...
    foreach ($current_page as $key => $term) {
      ...
      if ($taxonomy_vocabulary->getHierarchy() != VocabularyInterface::HIERARCHY_MULTIPLE && $tree_count > 1) {
        $parent_fields = TRUE;
    ...
    if (($taxonomy_vocabulary->getHierarchy() !== VocabularyInterface::HIERARCHY_MULTIPLE && $tree_count > 1) && $change_weight_access->isAllowed()) {
