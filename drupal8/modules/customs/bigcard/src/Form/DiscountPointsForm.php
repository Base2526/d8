...
class DiscountPointsForm extends FormBase {

    /**
     * {@inheritdoc}.
     */
    public function getFormId() {
        return 'discount_points_form';
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $content = $cumulative_exchange_points->get('field_discount_point_content')->getValue()[0]['value'];
