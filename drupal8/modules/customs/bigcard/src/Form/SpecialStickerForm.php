...
class SpecialStickerForm extends FormBase {

    /**
     * {@inheritdoc}.
     */
    public function getFormId() {
        return 'special_stricker_form';
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $cumulative_exchange_points = ConfigPages::config('collecting_big_stickers');
        $content = $cumulative_exchange_points->get('field_special_big_sticker')->getValue()[0]['value'];
